...
MAX_OPTION_PREMIUM_PER_TRADE = _env_float(
    "MAX_OPTION_PREMIUM_PER_TRADE", 500.0
)
MAX_CONTRACTS_PER_TRADE = _env_int("MAX_CONTRACTS_PER_TRADE", 1)
# Compatibility aliases for older deployments. Both long-call signal variants
# now share the same strategy-level premium rule.
MAX_PREMIUM_PER_TRADE = MAX_OPTION_PREMIUM_PER_TRADE
MAX_TOTAL_OPTION_PREMIUM = _env_float("MAX_TOTAL_OPTION_PREMIUM", 1000.0)
REGULAR_MAX_PREMIUM_PER_TRADE = MAX_OPTION_PREMIUM_PER_TRADE
MAX_100_PREMIUM_PER_TRADE = MAX_OPTION_PREMIUM_PER_TRADE
...
BACKTEST_STARTING_CASH = _env_float(
...
REJECTED_TRADES_FILE = "logs/rejected_trades.csv"
